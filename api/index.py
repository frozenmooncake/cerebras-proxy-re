...
# VERSION & CHANGELOG
# ======================================================
VERSION = "2.0.3-OpenCode-Full"  # 完整版：保留全部 Dashboard/Debug 面板 + 完美兼容 OpenCode/Cursor
...
# ======================================================
# API ENDPOINT: CHAT COMPLETIONS (Async Streaming & OpenCode Compatible)
# ======================================================
                ...
                async def event_generator():
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            # OpenCode / Cursor 流式响应规范：先发一个带 role 初始帧
                            first_chunk = {
                                "id": request_id,
...
# ======================================================
# OPENCODE & OPENAI COMPATIBILITY ENDPOINTS
# ======================================================
@app.get("/v1")
async def root_v1():
